    ...
    double? CalculatedPercent = null)
{
    ...
    public string ToLogLine()
    {
        ...
        Add(parts, "beforeHostAllocated", BeforeBytes is null ? null : $"{BeforeBytes} ({SizeFormatter.Format(BeforeBytes.Value)})");
        Add(parts, "afterHostAllocated", AfterBytes is null ? null : $"{AfterBytes} ({SizeFormatter.Format(AfterBytes.Value)})");
        Add(parts, "savedHostAllocated", SavedBytes is null ? null : $"{SavedBytes} ({SizeFormatter.Format(SavedBytes.Value)})");
